...
class JwtAccessToken extends AccessToken
{
     ...
     */
    public function __construct(PublicKeyInterface $publicKeyStorage = null, AccessTokenStorageInterface|null $tokenStorage = null, RefreshTokenInterface|null $refreshStorage = null, array $config = array(), EncryptionInterface|null $encryptionUtil = null)
    {
